...
int main() {
    ...
    if (ipc > 2.0) {
        ...
        printf("Inference: The CPU's out-of-order engine is extremely effective at finding and exploiting the instruction-level \n parallelism in this specific workload, keeping its multiple execution units busy.\n");
    } else if (ipc > 1.0) {
        ...
        printf("Inference: The complex dependency chain in the benchmark is stalling the pipeline, preventing the CPU from using its parallel execution units effectively.\n");
    }
